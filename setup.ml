...
(* OASIS_START *)
(* DO NOT EDIT (digest: fb96416d03441f8004d8c7eb069388c9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["ygrek"];
          homepage = Some "http://ygrek.org.ua/p/ocaml-hdfs/";
          bugreports = None;
     ...
     oasis_digest = Some "\000\222\210OM\028\247\2512z-\189\141\210\153\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
