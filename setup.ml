...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9502b37525fc5af9d60e62f251cff8f9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description = Some "API to access HDFS cluster";
          categories = [];
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("make", ["gen"])))];
               post_command = [(OASISExpr.EBool true, None)];
               };
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Q1\016\186\"\157\129\025\149\134\028a\241\224\197G";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
