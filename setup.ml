...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9ac0252805d7ab06130033f008b2b218) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["ygrek"];
          homepage = Some "http://hdfs.forge.ocamlcore.org/";
          bugreports = None;
          synopsis = "libhdfs bindings";
          description = Some [OASISText.Para "API to access HDFS cluster"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["hdfs_stubs.c"; "hdfs_stubs_manual.c"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lhdfs"])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "hdfs"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlidl"];
                      bs_interface_patterns =
                        [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for hdfs";
                      doc_authors = ["ygrek"];
                      doc_abstract = None;
     ...
     oasis_digest = Some "Q\243lX\193\229\132^\1807\244,\182\"\189\134";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
